...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "com.simplixone.build_type";
    private static final String DEVICE_NAME = "com.simplixone.device";
    private static final String OTA_APP_PACKAGE = "com.simplixone.ota";
